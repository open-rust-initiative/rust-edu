...
The `rust-edu` project relies on community contributions and aims to simplify getting started. To develop `rust-edu`, clone the repository, then install all dependencies, run the test suite and try it out locally. Pick an issue, make changes, and submit a pull request for community review.
...
3. Contribute code: If you want to develop and contribute code, follow these steps:
   ...
   - Fork the `rust-edu` repository and create a branch for your changes.
   ...
   - Respond to any feedback on your pull request. The `rust-edu` maintainers will review your changes and may request modifications before merging. Please ensure your code is properly formatted and follows the same style as the existing codebase.
